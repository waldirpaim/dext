...
* **O que reaproveitar:** A lógica de identificação de classes, propriedades e leitura de atributos customizados usada nas Facades e Documentação HTML do CLI.
...
* [ ] Implementar estratégia para evitar conflitos de nomes de unidades do DelphiAST (Ex: Prefixar nomes ou usar pacotes de runtime isolados).
